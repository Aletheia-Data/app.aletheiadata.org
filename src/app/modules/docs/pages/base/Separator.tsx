    ...
    <>
      ...
      <div className="py-10">
        ...
        <div className="py-5">
          <div className="rounded border p-10">
            <div className="separator my-10" />
            <div className="separator border-2 my-10" />
            <div className="separator border-3 my-10" />
            <div className="separator border-4 my-10" />
            <div className="separator border-5 my-10" />
          </div>
        </div>
        ...
        <div className="py-5">
          <div className="rounded border p-10">
            <div className="bg-dark my-10 py-5">
              <div className="separator border-white" />
            </div>
            <div className="separator border-primary my-10" />
            <div className="separator border-light my-10" />
            <div className="separator border-secondary my-10" />
            <div className="separator border-success my-10" />
            <div className="separator border-info my-10" />
            <div className="separator border-warning my-10" />
            <div className="separator border-danger my-10" />
            <div className="separator border-dark my-10" />
          </div>
        </div>
      ...
      <div className="pt-10">
        ...
        <div className="py-5">
          ...
          <code>.separator-dashed</code>classes to change a separator&apos;s
          border style:
        </div>
        <div className="py-5">
          <div className="rounded border p-10">
            <div className="separator separator-dotted border-dark my-10" />
            <div className="separator separator-dashed border-dark my-10" />
          </div>
        </div>
