...
export function Example6Opacity(): JSX.Element {
  return (
    <div className="pb-10">
      ...
      <div className="py-5">
        <div className="rounded border p-10 d-flex flex-wrap">
          <div className="d-flex flex-column me-5 mb-5">
            <div className="w-90px h-90px opacity-0 bg-dark flex-grow-1" />
            <div className="fw-bold py-2">opacity-0</div>
          </div>
          <div className="d-flex flex-column me-5 mb-5">
            <div className="w-90px h-90px opacity-5 bg-dark flex-grow-1" />
            <div className="fw-bold py-2">opacity-5</div>
          </div>
          <div className="d-flex flex-column me-5 mb-5">
            <div className="w-90px h-90px opacity-10 bg-dark flex-grow-1" />
            <div className="fw-bold py-2">opacity-10</div>
          </div>
          <div className="d-flex flex-column me-5 mb-5">
            <div className="w-90px h-90px opacity-15 bg-dark flex-grow-1" />
            <div className="fw-bold py-2">opacity-15</div>
          </div>
          <div className="d-flex flex-column me-5 mb-5">
            <div className="w-90px h-90px opacity-20 bg-dark flex-grow-1" />
            <div className="fw-bold py-2">opacity-20</div>
          </div>
          <div className="d-flex flex-column me-5 mb-5">
            <div className="w-90px h-90px opacity-25 bg-dark flex-grow-1" />
            <div className="fw-bold py-2">opacity-25</div>
          </div>
          <div className="d-flex flex-column me-5 mb-5">
            <div className="w-90px h-90px opacity-50 bg-dark flex-grow-1" />
            <div className="fw-bold py-2">opacity-50</div>
          </div>
          <div className="d-flex flex-column me-5 mb-5">
            <div className="w-90px h-90px opacity-75 bg-dark flex-grow-1" />
            <div className="fw-bold py-2">opacity-75</div>
          </div>
          <div className="d-flex flex-column me-5 mb-5">
            <div className="w-90px h-90px opacity-100 bg-dark flex-grow-1" />
