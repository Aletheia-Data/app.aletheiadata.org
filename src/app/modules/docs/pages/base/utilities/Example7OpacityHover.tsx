...
export function Example7OpacityHover(): JSX.Element {
  return (
    <div className="pb-10">
      <h1 className="anchor fw-bolder mb-5" id="Example7OpacityHover">
        <a href="#Example7OpacityHover" />
        Opacity Hover
      </h1>
      ...
      <div className="py-5">
        <div className="rounded border p-10 d-flex flex-wrap">
          <div className="d-flex flex-column me-5 mb-5">
            <div className="w-100px h-100px opacity-100 opacity-0-hover bg-dark flex-grow-1" />
            <div className="fw-bold py-2">opacity-0-hover</div>
          </div>
          <div className="d-flex flex-column me-5 mb-5">
            <div className="w-100px h-100px opacity-100 opacity-5-hover bg-dark flex-grow-1" />
            <div className="fw-bold py-2">opacity-5-hover</div>
          </div>
          <div className="d-flex flex-column me-5 mb-5">
            <div className="w-100px h-100px opacity-100 opacity-10-hover bg-dark flex-grow-1" />
            <div className="fw-bold py-2">opacity-10-hover</div>
          </div>
          <div className="d-flex flex-column me-5 mb-5">
            <div className="w-100px h-100px opacity-100 opacity-15-hover bg-dark flex-grow-1" />
            <div className="fw-bold py-2">opacity-15-hover</div>
          </div>
          <div className="d-flex flex-column me-5 mb-5">
            <div className="w-100px h-100px opacity-100 opacity-20-hover bg-dark flex-grow-1" />
            <div className="fw-bold py-2">opacity-20-hover</div>
          </div>
          <div className="d-flex flex-column me-5 mb-5">
            <div className="w-100px h-100px opacity-100 opacity-25-hover bg-dark flex-grow-1" />
            <div className="fw-bold py-2">opacity-25-hover</div>
          </div>
          <div className="d-flex flex-column me-5 mb-5">
            <div className="w-100px h-100px opacity-100 opacity-50-hover bg-dark flex-grow-1" />
            <div className="fw-bold py-2">opacity-50-hover</div>
          </div>
          <div className="d-flex flex-column me-5 mb-5">
            <div className="w-100px h-100px opacity-100 opacity-75-hover bg-dark flex-grow-1" />
            <div className="fw-bold py-2">opacity-75-hover</div>
          </div>
          <div className="d-flex flex-column me-5 mb-5">
            <div className="w-100px h-100px opacity-100 opacity-100-hover bg-dark flex-grow-1" />
