    ...
    <>
      ...
      <div className="py-10">
        ...
        <div className="py-5">
          ...
          <a className="fw-bolder" href="" target="_blank">
            height classes
          </a>
      ...
      <div className="py-10">
        ...
        <div className="py-5">
          Add
          <code>.card-px-0</code>to reset a card header, body and footer&apos;s
          side paddings:
        </div>
      ...
      <div className="py-10">
        ...
        <div className="py-5">
          Add
          <code>.card-border</code>to a card to remove it&apos;s shadow and
          enable border.
        </div>
