          ...
          <div className="card-body py-10">
            <div className="tab-content" id="myTabContent">
                ...
                >
                  ...
                  <div className="mb-5">
                    ...
                    >
                      ...
                      simply ignore these messages as bundled plugins do not
                  ...
                  <div className="mb-5">
                    ...
                    >
                      ...
                      registration/activation once installed, however, you can
                      simply ignore these messages as bundled plugins do not
                      require activation or registration. The plugin will still
                      work as intended with the theme once the theme has been
                      activated/registered. When a plugin is updated, the theme
                      author will include the latest version of the bundled
                      plugin with their next theme update.
                    </div>
                    {/*end::Body*/}
                  </div>
                  {/*end::Item*/}
              ...
              <div className="tab-pane fade" id="kt_tab_pane_3" role="tabpanel">
                <h2 className="text-dark fw-bolder fs-1 mb-5">IPFS</h2>
